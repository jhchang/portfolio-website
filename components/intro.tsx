    ...
    >
      <div className='flex items-center justify-center'>
        <div className='relative'>
          ...
          >
            <Image
              src='https://lh3.googleusercontent.com/a/ACg8ocLYQIIHLMvEBUFa0QHM-NqvwvD3gn6BbenaJMRlVl-HedAwbTv7Kg=s360-c-no'
              alt='Justin portrait'
              width='192'
              height='192'
              quality='95'
      ...
      >
        ...
        <a
          ...
          href='https://www.linkedin.com/in/justin-h-chang/'
          target='_blank'
        >
          <BsLinkedin />
        </a>
